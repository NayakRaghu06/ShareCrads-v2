  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.socialRow}>
        ...
        {d?.youtube ? (<TouchableOpacity onPress={() => Linking.openURL(d.youtube)} style={styles.iconBtn}><Ionicons name="logo-youtube" size={20} color="#D4AF37" /></TouchableOpacity>) : null}
